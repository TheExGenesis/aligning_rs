...
# Config
    ...
    for mediatorParam in mediatorParamPool:
        ...
        for i, ep in enumerate(episodes):
            ...
            (_coconut_partial(storeEpisode, {1: '{_coconut_format_0}/{_coconut_format_1}{_coconut_format_2}'.format(_coconut_format_0=(storagePath), _coconut_format_1=(expName), _coconut_format_2=(i))}, 2))(ep)
...
# for i,ep in enumerate(episodes):
#   ep['happenings'] = pd.DataFrame.from_dict(ep['happenings']).T
#   ep |> storeEpisode$(?, f'{storagePath}/{expName}{i}')
