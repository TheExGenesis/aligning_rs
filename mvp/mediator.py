...
# mediatorPickPartner :: mediator -> graph -> vertex -> agent
...
@_coconut_tco
def mediatorPickPartner(m, g, v):
    agents = g.vp.agents
    return _coconut_tail_call(optimizePartnerPick, g.vertices())

@_coconut_tco
def selflessMediatorPickPartner(g, v):
    agents = g.vp.agents
    return _coconut_tail_call(optimizePartnerPick, makeAgentIdEval(agents, v), g.vertices())

@_coconut_tco
def evilMediatorPickPartner(g, v):
    agents = g.vp.agents
